...
async function runVerifyJob(job, helpers, config) {
  ...
  const verifyPrompt = [
    ...
    ``,
    `Report a concise follow-up covering only what changed in your assessment. If you post to the PR,`,
    `post exactly ONE short comment via \`gh pr comment ${meta.number}\` — do NOT repeat your original`,
    `review, do NOT re-raise points you now consider ANSWERED, and do NOT approve.`,
