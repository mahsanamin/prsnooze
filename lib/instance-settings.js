...
const AVATARS = Object.freeze(AVATAR_SEEDS.map(([id, label, background]) => ({
  id,
  label,
  url: `https://api.dicebear.com/9.x/personas/svg?seed=${encodeURIComponent(label)}&backgroundColor=${background}&radius=18`,
})));
