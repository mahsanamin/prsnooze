...
function defaultPreferencesBlock({
  ...
  const lines = [
    ...
    "",
    "If every concern you'd raise is already covered, your output is exactly",
    "the single line: \"No new issues found beyond the existing reviews.\"",
    "Then post once and stop. Do not pad with prose.",
    "",
